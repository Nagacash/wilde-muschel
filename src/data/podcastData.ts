...
export const SAMPLE_EPISODES: Episode[] = [
  {
    ...
    category: 'Kiez-Geflüster',
    description: 'Eine Kiez-Geschichte über eine Kollegin, die nicht dem Schönheitsideal entsprach — und trotzdem absahnte, weil sie Sex wirklich liebte und die Freier das gespürt haben. Dazu, wie sich St. Pauli verändert hat, und die Begegnungen mit dem legendären „schönen Klaus“.',
    teaserSnippet: '„Die war kein Pin-up. Aber sie hat’s geliebt — und die Kerle sind Schlange gestanden. Das kauft keine OP der Welt.“',
    tags: ['Kiez', 'Kolleginnen', 'Schöner Klaus', 'St. Pauli'],
    audioUrl: '/episodes/ep-08.mp3',
    plays: 0,
    isExplicit: true,
    featured: true
  },
  {
    ...
    publishDate: '19. August 2026',
    category: 'Reeperbahn',
    description: 'Ein nostalgischer Rückblick auf die Blütezeit des Hamburger Kiez. Die Sprecherin teilt Geschichten über legendäre Kieztypen wie „Den schönen Klaus“ und vergleicht das einmalige Gemeinschaftsgefühl von damals mit dem durchkommerzialisierten Nachtleben von heute.',
    teaserSnippet: '„Den schönen Klaus vergessen die nicht. Damals war St. Pauli ein Dorf. Heute ist’s ein Laden.“',
    tags: ['St. Pauli', 'Kiez', 'Nostalgie', 'Reeperbahn'],
    audioUrl: '/episodes/ep-07.mp3',
    plays: 0,
    isExplicit: true
  },
  {
    ...
    category: 'Real-Talk',
    description: 'Ein Blick hinter die Kulissen exklusiver Etablissements und der Techniken, Kunden ohne echte Intimität zu steuern. Die Sprecherin beschreibt ihre Arbeit als reine Schauspielkunst, bei der klare Grenzen, Täuschung und Psychologie der Schlüssel zum Erfolg waren.',
    teaserSnippet: '„Intimität? Theater. Grenzen, Täuschung, Psychologie — das war die eigentliche Arbeit.“',
    tags: ['Real-Talk', 'Grenzen', 'Kulissen', 'Psychologie'],
    audioUrl: '/episodes/ep-06.mp3',
    plays: 0,
    isExplicit: true
  },
  {
    ...
    category: 'Reeperbahn',
    description: 'Ein kritischer Blick auf die Entwicklung der Sexarbeit im Laufe der Jahre. Die Sprecherin vergleicht die bargeldintensive, alte Schule des Kiez-Lebens mit modernen digitalen Bezahlsystemen, sich verändernden Kundendynamiken und dem Wandel des gesellschaftlichen Klimas.',
    teaserSnippet: '„Früher Bargeld auf den Tisch. Heute piept das Handy. Der Kiez hat sich gewaschen, aber nicht immer zum Guten.“',
    tags: ['Rotlicht', 'Kiez', 'Wandel', 'Reeperbahn'],
    audioUrl: '/episodes/ep-05.mp3',
    plays: 0,
    isExplicit: true
  },
  {
    ...
    category: 'Freier',
    description: 'Von getragener Unterwäsche zu Spitzenpreisen bis hin zum Verkauf ungewöhnlicher Alltagsgegenstände: Mit viel Humor erzählt die Sprecherin, wie sie selbst die skurrilsten Kundenanfragen in lukrative Einnahmequellen verwandelte.',
    teaserSnippet: '„Getragene Wäsche, komische Alltagsdinge — wenn der Preis stimmt, wird aus skurril ein Geschäft.“',
    tags: ['Freier', 'Geschäft', 'Humor', 'Kiez'],
    audioUrl: '/episodes/ep-04.mp3',
    plays: 0,
    isExplicit: true
  },
  {
    ...
    category: 'Real-Talk',
    description: 'Ein tiefer Einblick in die psychologischen Hintergründe extremer Neigungen. Die Sprecherin reflektiert, wie die Intimwünsche eines Stammkunden mit schweren Vergangenheits-Traumata verknüpft waren und wie diese Erkenntnis ihren Blick auf das Gewerbe nachhaltig veränderte.',
    teaserSnippet: '„Plötzlich war das kein Fetisch mehr, das war ein offenes Trauma. Und ich hab’s zu spät kapiert.“',
    tags: ['Real-Talk', 'Fetisch', 'Trauma', 'Psychologie'],
    audioUrl: '/episodes/ep-03.mp3',
    plays: 0,
    isExplicit: true
  },
  {
    ...
    description: 'Die Protagonistin spricht über extrem ausgefallene Kundenwünsche – von speziellen Fetischen bis hin zu medizinischen Szenarien – und schildert den genauen Moment, in dem eine Anfrage ihre persönlichen Grenzen überschritt und sie den Job abbrach.',
    teaserSnippet: '„Es gibt Wünsche, da mach ich mit — und dann kommt der eine Satz, wo ich den Mantel nehme und gehe.“',
    tags: ['Grenzen', 'Tabus', 'Fetisch', 'Sex-Stories'],
    audioUrl: '/episodes/ep-02.mp3',
    plays: 0,
    isExplicit: true
  },
  {
